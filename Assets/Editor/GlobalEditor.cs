...
public class GlobalEditor : Editor
{
	...
	{
		target_.controlParams = EditorGUILayout.Foldout(target_.controlParams, "Parametres controles");
		...
		if(target_.controlParams)
		{
			...
			this.target_.hudLimitX						= 0.01f * addSlider (100.0f * this.target_.hudLimitX, 0.0f, 40.0f,
				"Largeur de zone",
				"Largeur de la zone aux bords de l'ecran pour le deplacement",
				"%");
			
			/*
			this.target_.comfortZone					= addSlider (this.target_.comfortZone, 20f,
				100f,
				"Deadzone de slide",
				"Zone de securite du slide",
				"px.");
			
			this.target_.minSwipeDist				= addSlider (this.target_.minSwipeDist, 10f,
				200f, 
				"Distance de slide min.",
				"Distance minimum de slide pour activer le saut",
				"px.");
			
			this.target_.maxSwipeTime					= addSlider (this.target_.maxSwipeTime, 0.1f,
				2f,
				"Temps de slide max.", 
				"Temps maximal de detection du slide", 
				"sec.");
			*/
			
			this.target_.maxTapTime						= addSlider (this.target_.maxTapTime,
				0.1f, 
				0.5f, 
				"Temps de tap max.",
				"Temps maximal de detection du tap pour le saut",
				"sec.");
		
			closeBox ();
		}
		
		target_.playerParams = EditorGUILayout.Foldout(target_.playerParams, "Parametres joueur");
		...
		if(target_.playerParams)
		{
			...
			this.target_.playerSpeed					= addFloatField (this.target_.playerSpeed,
				"Vitesse",
				"Vitesse du déplacement du personnage au sol et en l'air",
				"unites/s");
			
			this.target_.playerJumpForce				= addFloatField (this.target_.playerJumpForce,
				"Hauteur du saut", 
				"Puissance de l'impulsion de saut",
				"unites");
			
			this.target_.playerDamping					= addFloatField (this.target_.playerDamping,
				"Amortissement", 
				"Friction de l'air en saut", 
				"u.a");
			
			this.target_.playerGravityScale				= addFloatField (this.target_.playerGravityScale,
				"Acceleration en chute",
				"Facteur d'acceleration pendant une chute", 
				"u.a");
		...
		target_.smallEnemyParams = EditorGUILayout.Foldout(target_.smallEnemyParams, "Parametres petits ennemis");
		...
		if(target_.smallEnemyParams)
		{
			...
			this.target_.smallEnemy.jumpForce				= addFloatField (this.target_.smallEnemy.jumpForce,
				"Hauteur du saut", 
				"Puissance de l'impulsion de saut",
				"unites");
			
			this.target_.smallEnemy.damping					= addFloatField (this.target_.smallEnemy.damping,
				"Amortissement",
				"Friction de l'air en saut",
				"u.a");
			
			this.target_.smallEnemy.gravityScale			= addFloatField (this.target_.smallEnemy.gravityScale,
				"Acceleration en chute",
				"Facteur d'acceleration pendant une chute", 
				"u.a");
			
			this.target_.smallEnemy.patrolSpeed				= addFloatField (this.target_.smallEnemy.patrolSpeed,
				"Vitesse de Patrouille", 
				"Vitesse du déplacement de l'enemis en patrouille", 
				"unites/s");
			
			this.target_.smallEnemy.frontSpottingDistance	= addFloatField (this.target_.smallEnemy.frontSpottingDistance,
				"Reperage Avant",
				"Distance reperage du personnage a l'avant", 
				"unites");
			
			this.target_.smallEnemy.backSpottingDistance	= addFloatField (this.target_.smallEnemy.backSpottingDistance, 
				"Reperage Arriere",
				"Distance reperage du personnage a l'arriere", 
				"unites");
			
			this.target_.smallEnemy.pursuitSpeed			= addFloatField (this.target_.smallEnemy.pursuitSpeed,
				"Vitesse de Poursuite",
				"Vitesse du déplacement de l'enemis en poursuite", 
				"unites/s");
			
			this.target_.smallEnemy.reach					= addFloatField (this.target_.smallEnemy.reach,
				"Portee d'Attaque",
				"Distance de passage en attaque",
				"unites");
			
			this.target_.smallEnemy.alertRange				= addFloatField (this.target_.smallEnemy.alertRange,
				"Distance d'Alerte",
				"Distance d'abandon de la poursuite", 
				"unites");
			
			this.target_.smallEnemy.hitDistance				= addFloatField (this.target_.smallEnemy.hitDistance,
				"Distance de Degats", 
				"Distance d'effet de l'attaque",
				"unites");
			
			this.target_.smallEnemy.hitTime					= addFloatField (this.target_.smallEnemy.hitTime,
				"Temps d'attaque", 
				"Temps d'attente de l'animation avant la frame faisant effet", 
				"secondes");
		...
		target_.bigEnemyParams = EditorGUILayout.Foldout(target_.bigEnemyParams, "Parametres gros ennemis");
		...
		if(target_.bigEnemyParams)
		{
			...
			this.target_.bigEnemy.jumpForce					= addFloatField (this.target_.bigEnemy.jumpForce,
				"Hauteur du saut",
				"Puissance de l'impulsion de saut", 
				"unites");
			
			this.target_.bigEnemy.damping					= addFloatField (this.target_.bigEnemy.damping,
				"Amortissement",
				"Friction de l'air en saut",
				"u.a");
			
			this.target_.bigEnemy.gravityScale				= addFloatField (this.target_.bigEnemy.gravityScale,
				"Acceleration en chute",
				"Facteur d'acceleration pendant une chute",
				"u.a");
			
			this.target_.bigEnemy.patrolSpeed				= addFloatField (this.target_.bigEnemy.patrolSpeed,
				"Vitesse de Patrouille",
				"Vitesse du déplacement de l'enemis en patrouille", 
				"unites/s");
			
			this.target_.bigEnemy.frontSpottingDistance		= addFloatField (this.target_.bigEnemy.frontSpottingDistance,
				"Reperage Avant",
				"Distance reperage du personnage a l'avant",
				"unites");
			
			this.target_.bigEnemy.backSpottingDistance		= addFloatField (this.target_.bigEnemy.backSpottingDistance,
				"Reperage Arriere",
				"Distance reperage du personnage a l'arriere", 
				"unites");
			
			this.target_.bigEnemy.pursuitSpeed				= addFloatField (this.target_.bigEnemy.pursuitSpeed, 
				"Vitesse de Poursuite", 
				"Vitesse du déplacement de l'enemis en poursuite", 
				"unites/s");
			
			this.target_.bigEnemy.reach						= addFloatField (this.target_.bigEnemy.reach, 
				"Portee d'Attaque", 
				"Distance de passage en attaque", 
				"unites");
			
			this.target_.bigEnemy.alertRange				= addFloatField (this.target_.bigEnemy.alertRange, 
				"Distance d'Alerte",
				"Distance d'abandon de la poursuite",
				"unites");
			
			this.target_.bigEnemy.hitDistance				= addFloatField (this.target_.bigEnemy.hitDistance, 
				"Distance de Degats",
				"Distance d'effet de l'attaque", 
				"unites");
			
			this.target_.bigEnemy.hitTime					= addFloatField (this.target_.bigEnemy.hitTime,
				"Temps d'attaque", 
				"Temps d'attente de l'animation avant la frame faisant effet",
				"secondes");
		...
		target_.cameraParams = EditorGUILayout.Foldout(target_.cameraParams, "Parametres camera");
		...
		if(target_.cameraParams)
		{
			...
			this.target_.cameraSmooth 						= addSlider(this.target_.cameraSmooth,
				0.0f, 
				1.0f,
				"Duree d'interpolation",
				"Duree d'interpolation du mouvement de la camera", 
				"sec.");	
			
			this.target_.cameraZOffset						= addSlider(this.target_.cameraZOffset,
				0.0f,
				30.0f, 
				"Distance camera",
				"Distance entre la caméra et le joueur (zoom/dezoom)",
				"unites");
		...
		target_.objectParams = EditorGUILayout.Foldout(target_.objectParams, "Parametres objets");
		...
		target_.soundParams = EditorGUILayout.Foldout(target_.soundParams, "Parametres son");
		...
		if(target_.soundParams)
		{
			...
			this.target_.AttractorOnSound = addSoundField(this.target_.AttractorOnSound,
				false, 
				"Son des plaques d'attraction (active)", 
				"Son des plaques d'attraction(active)");
			
			this.target_.AttractorOffSound = addSoundField(this.target_.AttractorOffSound,
				false, 
				"Son des plaques d'attraction (desactive)", 
				"Son des plaques d'attraction(desactive)");
			...
			this.target_.ElectricSound = addSoundField(this.target_.ElectricSound,
				false,
				"Son de killzone electrique",
				"Son de killzone electrique");
